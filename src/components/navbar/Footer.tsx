...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="bg-white dark:bg-slate-900 px-1 pb-1 lg:px-8 mt-2.5"
      aria-labelledby="footer-heading"
    >
      <div className="my-2 md:flex md:items-center md:justify-between">
        <div className="flex text-gray-700 justify-center items-center space-x-6 md:order-2">
          <a
            key="contact"
            href="#"
          ...
          <a
            ...
            className="text-xs text-gray-700 hover:text-gray-300 hover:cursor-pointer"
          >
            Privacy
          </a>
        </div>
        <p className="text-xs text-gray-700 pr-6">
