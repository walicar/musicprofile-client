      ...
      <div className="flex items-center flex-auto">
        <div className="w-full">
          <input
            ...
            value="password"
            disabled
            className="disabled:cursor-not-allowed disabled:bg-gray-50 dark:disabled:bg-slate-800 disabled:text-gray-500 dark:disabled:ring-slate-600 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          />
        </div>
        <button
          type="button"
                  ...
                  <div>
                    <div className="">
                      <div className="flex justify-between">
                        ...
                        <button
                          type="button"
                          className="inline-flex rounded-md bg-white dark:text-neutral-50 text-gray-400 dark:hover:text-neutral-400 hover:text-gray-500 dark:bg-slate-900 focus:outline-none"
                          onClick={() => {
                            setOpen(false);
                            clearForm();
                          }}
